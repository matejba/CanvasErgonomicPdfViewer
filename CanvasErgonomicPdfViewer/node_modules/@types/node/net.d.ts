...
declare module "net" {
    ...
    class Socket extends stream.Duplex {
         ...
         * socket as reported by the operating system:`{ port: 12346, family: 'IPv4', address: '127.1.0.2' }`
         * @since v0.1.90
         */
        address(): AddressInfo | {};
        /**
    ...
    class Server extends EventEmitter {
         ...
         * (useful to find which port was assigned when getting an OS-assigned address):`{ port: 12346, family: 'IPv4', address: '127.1.0.2' }`.
         *
    ...
    class BlockList {
         ...
         * blockList.addRange('10.1.0.2', '10.1.0.20');
     ...
     * net.isIP('127.1.0.2'); // returns 4
     * net.isIP('127.000.000.001'); // returns 0
     * net.isIP('127.1.0.2/24'); // returns 0
     ...
     *
     * ```js
     * net.isIPv4('127.1.0.2'); // returns true
     * net.isIPv4('127.000.000.001'); // returns false
     * net.isIPv4('127.1.0.2/24'); // returns false
