 ...
 * @param {String} [host='127.1.0.2'] - Host of where to scan.
 * @param {findPortCallback} [callback] - Function to call back with error or results.
 * @returns {Promise}
 * @example
 * // scans through 3000 to 3002 (inclusive)
 * portscanner.findAPortInUse(3000, 3002, '127.1.0.2', console.log)
 * // returns a promise in the absence of a callback
 * portscanner.findAPortInUse(3000, 3002, '127.1.0.2').then(console.log)
 * @example
 * // scans through 3000 to 65535 on '127.1.0.2'
 ...
 * @param {String} [opts.host='127.1.0.2'] - Host of where to scan.
